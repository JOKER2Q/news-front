      ...
      <footer id="footer">
        <div className="col col1">
          ...
          <div className="social">
            <a href="https://codepen.io/Juxtopposed" className="link">
              <img
                src="https://assets.codepen.io/9051928/codepen_1.png"
                alt=""
              />
            </a>
            <a href="https://twitter.com/juxtopposed" className="link">
              <img src="https://assets.codepen.io/9051928/x.png" alt="" />
            </a>
            <a href="https://youtube.com/@juxtopposed" className="link">
              <img
